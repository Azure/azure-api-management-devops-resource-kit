...
```
- 1.Products.template.json
- 2.Tags.template.json
- 3.namedValues.template.json
- 4.apis.template.json
- 5.globalServicePolicy.template.json
```

> **Note**, deploy the numbered files on the sequencial order, then all the APIs exported.
...
> **Note**, use the azure-pipelines.yml YAML pipeline is you prefer.
