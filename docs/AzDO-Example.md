# Continuous Integration and Continuos Deployment using Azure DevOps
...
[See more examples.](#extractorParameterFileExamples)
...
For this example, we will only use the option 2. Run the application with:
...
For more information on how to run the application and parameters, review the [Extractor](https://github.com/Azure/azure-api-management-devops-resource-kit/blob/master/src/APIM_ARMTemplate/README.md#extractor) documentation.

After executing the command above, you will see something similar to this:

![A screenshot](images/extractor.png)

The JSON files are extracted:

![A close up of text on a white background Description automatically generated](images/extracted-files.png)

Now, push them to your git-based repository:
...
2 - Configure the fields as show below:

![](images/build-pipeline1.png)

![](images/build-pipeline2.png)
...
3. Set [Deployment mode to Incremental](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/deployment-tutorial-pipeline#create-a-devops-project)
