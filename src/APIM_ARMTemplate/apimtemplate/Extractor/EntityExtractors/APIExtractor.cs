...
namespace Microsoft.Azure.Management.ApiManagement.ArmTemplates.Extract
{
	public class APIExtractor : EntityExtractor
	{
		...
		public async Task<Template> GenerateAPIsARMTemplateAsync(string apimname, string resourceGroup, string singleApiName, string singleRevisionName, string policyXMLBaseUrl, string fileFolder)
		{
		...
		public static JObject FormatoApi(string singleApiName, JObject oApi)
		{
			if (singleApiName != null)
			{
				...
				string objectSelector = $"$.value[?(@.name == '{singleApiName}')]";
