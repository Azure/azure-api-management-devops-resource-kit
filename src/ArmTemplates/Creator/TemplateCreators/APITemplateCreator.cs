...
namespace Microsoft.Azure.Management.ApiManagement.ArmTemplates.Creator.TemplateCreators
{
    public class APITemplateCreator : TemplateGeneratorBase
    {
        ...
        public List<TemplateResource> CreateChildResourceTemplates(APIConfig api)
        {
            ...
            List<ServiceApisProductTemplateResource> productAPIResources = api.products != null ? this.productAPITemplateCreator.CreateProductAPITemplateResources(api, dependsOn) : null;
