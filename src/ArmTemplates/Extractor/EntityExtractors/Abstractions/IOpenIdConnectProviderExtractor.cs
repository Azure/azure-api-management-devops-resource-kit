...
{
    public interface IOpenIdConnectProviderExtractor
    {
        Task<Template<OpenIdConnectProviderResources>> GenerateOpenIdConnectProvidersTemplateAsync(ExtractorParameters extractorParameters);
    }
}
