...
{
    public interface IIdentityProviderExtractor
    {
        Task<Template<IdentityProviderTemplateResources>> GenerateIdentityProvidersTemplateAsync(ExtractorParameters extractorParameters);
    }
}
